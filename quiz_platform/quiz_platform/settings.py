...
SECRET_KEY = 'django-insecure-+mxbo5$*(7e_^+(23gk0o5&n_m8zgsa8-3zh3z#&gz-4)6xkzl'
...
# Application definition - ONLY ONE LIST!
INSTALLED_APPS = [
...
# Database - using SQLite (easiest for development)
DATABASES = {
    'default': {
